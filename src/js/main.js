...
import { setupCallHandlers, toggleCall, toggleLocalVideo, toggleLocalAudio } from './calls.js';
...
ui.loginBtn.addEventListener('click', async () => {
    ...
    if (result.success) {
        ...
        if (ui.indicator) ui.indicator.className = "w-2.5 h-2.5 rounded-full bg-emerald-500 shadow-lg shadow-emerald-500/50";
...
async function activarSmartQueue() {
    ...
    // Validamos que la sesión esté establecida
    ...
    try {
        ...
        // Enviamos el estado directamente como string en minúsculas
        ...
        // Si falla, el problema suele ser la falta de rol de Operador en el panel
